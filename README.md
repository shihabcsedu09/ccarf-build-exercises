...
| 1.3 | [Implement Context Passing with Structured Metadata](domain1_agentic/ex_1_3_context_passing.py) | a bare 'Write the report.' against a subagent prompt carrying goal, findings and output shape |
